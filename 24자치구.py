...
print("\n2024.01.01 ~ 2024.05.30 시간대별 자치구별 자전거 대여건수:")

###7. 모든 시간 통틀어 가장 대여가 많이 발생한 자치구
# 서울 24개 자치구 목록
seoul_gu_list = [
...
for hour in hours:
    ...
    print(f"\n2024.01.01 ~ 2024.05.30 대여시간 {hour}시 자치구별 자전거 대여건수:")
...
total_count = len(df)
print(f"24년 자치구 총 데이터수: {total_count}개")
