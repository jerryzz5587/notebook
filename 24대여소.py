...
### 4. 시간대별 대여소별 대여건수 (대여가 가장 많은 대여소 출력) ###
print("\n2024.01.01 ~ 2024.05.30 시간대별 대여가 가장 많은 대여소 (상위 1개씩):")
...
for hour in hours:
    ...
    if len(hourly_station_rent_count) > 0:
        ...
        print(f"2024.01.01 ~ 2024.05.30 {hour}시: {most_rented_station[0]} {most_rented_station[1]}에서 {most_rented_station_count}건")

### 6. 모든 시간 통틀어 가장 대여가 많이 발생한 대여소 ###
...
total_count = len(df)
print(f"24년 대여소 총 데이터수: {total_count}개")
